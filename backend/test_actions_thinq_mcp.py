...
class ThinQMcpRoutingTests(unittest.IsolatedAsyncioTestCase):
    def setUp(self) -> None:
    ...
    async def test_thinq_status_routes_through_mcp(self) -> None:
        ...
        async def _fake_call(server_name, tool_name, params, legacy_handler=None):  # noqa: ANN001
            ...
            return (
                McpToolCallResult(
                    ...
                    structured_content={
                        "success": True,
                        "message": "ThinQ configurado.",
                        "data": {
                            "thinq_configured": True,
                            "country": "BR",
                            "api_base": "https://api-aic.lgthinq.com",
                            "devices_count": 2,
                        },
                    },
        ...
        self.assertEqual(result.message, "ThinQ configurado.")
        self.assertEqual(result.data.get("devices_count"), 2)
