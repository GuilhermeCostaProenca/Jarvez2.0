...
const DiceRoll_1 = require("./DiceRoll");
describe('DiceRoll', () => {
    it('should roll 1d6', () => {
        const diceRoll = new DiceRoll_1.DiceRoll(1, 6);
    ...
    it('should roll 2d6', () => {
        const diceRoll = new DiceRoll_1.DiceRoll(2, 6);
        const result = diceRoll.roll({ get: () => 1 });
    ...
    it('should roll 4d6 and discard lowest', () => {
        const diceRoll = new DiceRoll_1.DiceRoll(4, 6, 1);
        const result = diceRoll.roll({ get: () => 1 });
