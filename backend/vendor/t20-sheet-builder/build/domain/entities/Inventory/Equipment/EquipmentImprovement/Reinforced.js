...
class Reinforced extends EquipmentImprovement_1.EquipmentImprovement {
    constructor() {
        super(...arguments);
        this.name = EquipmentImprovementName_1.EquipmentImprovementName.reinforced;
        this.description = '+1 na penalidade de armadura e +1 na defesa';
        this.category = EquipmentImprovementCategory_1.EquipmentImprovementCategory.armorAndShield;
    }
}
exports.Reinforced = Reinforced;
