...
export declare abstract class Ability implements AbilityInterface {
    readonly name: AbilityName;
    readonly abilityType: AbilityType;
    abstract readonly effects: AbilityEffectsInterface;
    constructor(name: AbilityName, abilityType: AbilityType);
    addToSheet(transaction: TransactionInterface): void;
    private applyPassiveEffects;
    private registerTriggeredEffects;
    private registerActivateableEffects;
}
